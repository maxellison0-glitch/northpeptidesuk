...
const PRODUCT_CSS = `
    * { box-sizing: border-box; }
    ...
    .product-hero { max-width: 1160px; margin: 0 auto; padding: 46px 40px 32px; display: grid; grid-template-columns: minmax(280px, 0.9fr) minmax(320px, 1.1fr); gap: 34px; align-items: start; }
